...
var ExampleAPIModel = keystone.list('ExampleAPIModel');

/**
 * List ExampleAPIModels
 */
exports.list = function(req, res) {
	ExampleAPIModel.model.find(function(err, items) {
...
exports.create = function(req, res) {
  ...
  //Ensure the user has a valid CSRF token
	...
	var item = new ExampleAPIModel.model(),
...
exports.update = function(req, res) {
  ...
  if(admins.indexOf(userId) == -1) {
	...
	ExampleAPIModel.model.findById(req.params.id).exec(function(err, item) {
